...
class TransferFavouriteListAdapter(private val transferList: List<TransferList>) :
    RecyclerView.Adapter<TransferFavouriteListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_transfercontact_fav, parent, false)
